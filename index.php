...
<body>
  ...
  <i class="fa fa-plus"></i> تسجيل جديد
		...
		<thead>
			<tr>
			   <th class="text-" scope="col">التسلسل</th>
				<th class="text-center" scope="col">الاسم بالعربي</th>
				...
				<th class="text-center" scope="col"> الدورة</th>
			
				<th class="text-center" scope="col"> وقت إقامة الدورة</th>
        	...
        	while($row = mysqli_fetch_array($run_data))
        	{
				...
				<tr>
				<td class='text-llight'>$sl</td>
				<td class='text-light'> $u_l_name    $u_f_name</td>
				<td class='text-light'>$u_card</td>
				<td class='text-light'>$u_phone</td>
				<td class='text-light'>$u_email</td>
				<td class='text-light'>$u_state</td>
				<td class='text-light'>$u_gender</td>
				<td class='text-light'>$u_aadhar</td>
